      ...
      <main className="pt-32 px-[clamp(25px,4vw,64px)]">
        <div className="max-w-2xl">
          ...
          <div className="space-y-8 mb-12">
            ...
            <p ref={el => paragraphRefs.current[3] = el} className="text-2xl leading-tight md:leading-snug tracking-tight text-foreground opacity-0">Calmer lets you send an instant, thoughtful DM whenever someone comments on your post — with your link, offer, or message. Set it up once and forget it.
